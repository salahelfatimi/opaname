            ...
            <div className=" bg-secondary  py-2 ">
                <div className=" container flex flex-row justify-between items-center">
                    ...
                    <div className=" hidden  lg:flex flex-row gap-6 items-center">
                        ...
                        <Link href={'/pizzeria/menu-pizzeria'} className=" bg-primary py-3 px-4 hover:bg-secondary border border-primary hover:text-primary duration-700 text-sm font-bold text-white rounded">Commandez maintenant</Link>
                        
                    </div>
                    <Menu size={40} className="flex  lg:hidden bg-primary p-1 stroke-white"/>
                </div>
