        ...
        <div>
            <div className=" overflow-hidden  bg-[url('/french-food/bg.png')] bg-cover bg-bottom bg-secondary h-screen flex flex-col justify-center items-center gap-6">
                ...
                <div className=" flex flex-col lg:flex-row gap-6">
                    <Link href={'/french-food/menu-french-food'} className=" bg-primary py-2 px-6 font-black text-xl text-white rounded-full border-prbg-primary border-primary border-4 hover:border-white duration-700 hover:bg-secondary">Explorez notre Menu 🍽️</Link>
                    <div className=" relative">
                        ...
                        <div className={`bg-primary p-2 rounded font-bold text-white w-full   absolute bottom-16 flex flex-col gap-2 items-center justify-center ${open?'block':'hidden'}`}>
                            ...
                            <Link  href={'/french-food/menu-french-food'}  className=" hover:bg-secondary p-2 w-full text-center  duration-500 rounded-full text-sm">Commandez avec notre livreur</Link>
                        </div>
                    </div>
                </div>
            </div>
